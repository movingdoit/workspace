			...
			if(this.options.showSteps) {
				...
				function showSteps(wizsteps, steps, stepNum) {
					for(var i = 0; i < stepNum; i++) {
						...
						if(i+1 == stepNum) {
							wizsteps.append(
								'<div class="wstep last-child" data-step-num="'+i+'"><div class="donut"><i class="'+stepIcon+' f24"></i></div><span class="txt">'+stepText+'</span></div>'
							);
						} else {
							wizsteps.append(
								'<div class="wstep" data-step-num="'+i+'"><div class="donut"><i class="'+stepIcon+' f24"></i></div><span class="txt">'+stepText+'</span></div>'
							);
						}
					}
				}

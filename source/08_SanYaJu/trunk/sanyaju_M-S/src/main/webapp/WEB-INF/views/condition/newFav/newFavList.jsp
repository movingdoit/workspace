            ...
            <div class="span12">
                ...
                <div class="pro-box">
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody id="proList">
                            <c:if test="${not empty newFavs && newFavs.size>0}">
	                            <c:forEach items="${newFavs.content}" var="Item">
									<tr>
										...
										<td>
											<shiro:hasPermission name="user:edit">
												<a href="${ctx}/newFav/delete/${Item.id}" class="btn btn-mini">删除</a>
											</shiro:hasPermission>
										</td>
									</tr>
								</c:forEach>
							</c:if>
							<c:if test="${empty newFavs || newFavs.totalPages == 0 }">
								<tr>
		                            <td colspan="9" class="text-center"><strong>没有任何信息 *_*</strong></td>
		                        </tr>
							</c:if>
                            </tbody>
                        </table>
...
<script type="text/javascript" >
	...
	function movePriority(id, type){
		$.ajax({
	        type: "POST",
	        url:'${ctx}/newFav/move?id='+id+'&type='+type,
	        async: false,
